...
{
    public class BulletPooler : ObjectPooler<BulletModel>
    {
        public override BulletModel SpawnFromPool(Vector3 spawnPosition, Quaternion spawnRotation = default)
        {
        ...
        protected override void SpawnPool()
        {
            for (int i = 0; i < _pool.size; i++)
            {
                ...
                poolObject.GetComponent<BulletModel>().Init(i);
